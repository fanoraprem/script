...
echo -e " [\e[36m•4\e[0m] Cek Cpu & Ram"
echo -e " [\e[36m•5\e[0m] Generate cert ssl"
echo -e " [\e[36m•6\e[0m] Ganti Nameserver Slowdns"
echo -e " [\e[36m•7\e[0m] Renew Pubkey & Private Key Slowdns"
echo -e " [\e[36m•8\e[0m] Turn On / Off Slowdns Service Running"
echo -e ""
